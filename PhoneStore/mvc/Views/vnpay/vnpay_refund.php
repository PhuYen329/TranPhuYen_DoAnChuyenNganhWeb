<?php $a = "http://localhost:8080/PhoneStore"; ?>
        <!-- Bootstrap core CSS -->
        <!-- <link href="<?=$a?>/mvc/Views/vnpay/assets/bootstrap.min.css" rel="stylesheet"/> -->
        <!-- Custom styles for this template -->
        <!-- <link href="<?=$a?>/mvc/Views/vnpay/assets/jumbotron-narrow.css" rel="stylesheet">   -->
        <script src="<?=$a?>/mvc/Views/vnpay/assets/jquery-1.11.3.min.js"></script>
        ...
        <div class="container">
            ...
            <div style="width: 100% ;border-bottom: 2px solid black;padding-bottom: 20px" >
                <form action="<?=$a?>/mvc/Views/vnpay/vnpay_refund.php" id="frmCreateOrder" method="post">        
