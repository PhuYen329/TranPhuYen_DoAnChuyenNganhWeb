<main role="main">
    ...
    <div class="container mt-4">
        <form class="needs-validation" name="frmthanhtoan" method="post" action="#" style="margin-bottom: 30px;">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <div class="d-block my-3">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="httt-1">&nbsp;&nbsp;&nbsp;&nbsp;PAYPAL</label>
                            </div>
                            <div class="custom-control custom-radio">
                            ...
                            <div class="custom-control custom-radio">
                                <input id="httt-3" name="httt_ma" type="radio" class="custom-control-input" required="" value="momo">
                                <label class="custom-control-label" for="httt-3">&nbsp;&nbsp;&nbsp;&nbsp;MOMO</label>
                            </div>
                        </div>
                    </ul>
