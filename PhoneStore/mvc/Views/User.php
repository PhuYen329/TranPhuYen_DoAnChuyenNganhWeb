...
<head>
    ...
    <link rel="stylesheet" href="<?= $a ?>/mvc/Views/assets/css/bootstrap.min.css">
...
<body >
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light  sticky-top navbar-default bootsnav wow zoomIn">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0 nav-item dropdown" action="./Search" method="POST">
                ...
                <ul class="dropdown-menu " id="subitem" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item">
                        <a href="<?=$a?>/Home/Logout" class="dropdown-item">
                ...
                <div class="md-form my-0">
                    ...
                    <button class="btn btn-outline-primary my-2 my-sm-0" type="submit" name="btn-Search" >Search</button>
    ...
    data-welcome-message="Rất vui khi được hỗ trợ bạn!"
     data-autopopup="3600" 
     data-width="300" data-height="450"></div>
...
<!-- 
<div class="social-button" data-bs-spy="scroll">
    <div class="social-button-content">
       <a href="tel:0334596482" class="call-icon" rel="nofollow">
          <i class="fa fa-whatsapp" aria-hidden="true"></i>
          <div class="animated alo-circle"></div>
          <div class="animated alo-circle-fill  "></div>
           <span>Hotline: 0334596482</span>
        </a>
        <a href="sms:0981481368" class="sms">
          <i class="fa fa-weixin" aria-hidden="true"></i>
          <span>SMS: 0334596482</span>
        </a>
        <a href="https://www.facebook.com/TranPhuYen.Net/" class="mes">
          <i class="fa fa-facebook-square" aria-hidden="true"></i>
          <span>Nhắn tin Facebook</span>
        </a>
        <a href="http://zalo.me/0334596482" class="zalo">
          <i class="fa fa-commenting-o" aria-hidden="true"></i>
          <span>Zalo: 0334596482</span>
        </a>
    </div> -->
